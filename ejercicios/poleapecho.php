...
<body>
 <center>
            ...
            <div class="wrapper">
              <h1>Polea al Pecho</h1> <div class="div-img hidden" >    <img class="img" src="poleapecho.jpg" title="Foto2" alt="Foto2" height="630" width="300" style="border-radius:20px;"">  </div></div>
              <p>Para comenzar el ejercicio, como su nombre lo indica, necesitamos de una máquina de poleas específica para llevar a cabo este movimiento. Seleccionamos en la máquina el peso a cagar y nos sentamos frente a la polea, con las piernas fijadas bajo los cojines. Tomamos la barra que carga con la polea con las manos en pronación, de manera que las palmas miren hacia abajo, separadas más allá del ancho de los hombros y comenzamos el ejercicio.<br />
