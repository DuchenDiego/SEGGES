...
<body>
 <center>
            ...
            <div class="wrapper">
              <h1>Curl De Biceps con Barra En Pronacion</h1> <div class="div-img hidden" >    <img class="img" src="http://static.flickr.com/34/71520544_b69eb669d6_o.jpg" title="Foto2" alt="Foto2" height="630" width="300" style="border-radius:20px;"">  </div></div>
              <p>El curl de bíceps con barra en pronación o ‘reverse biceps curl’ es una variación de curl de bíceps en la cual se varía la posición del agarre. En vez de realizar el agarre en la típica posición supinadora, en este caso el agarre es en pronacion, lo que cambia totalmente las características del ejercicio y los músculos que trabajaremos con él.<br />
En el curl de bíceps con barra y agarre en pronación la carga de trabajo irá directamente a nuestro antebrazo, siendo muy efectivo para los braquiradiales y los músculos extensores de la muñeca.
</p>
        </center>
</body>
</html>