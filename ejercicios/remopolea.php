...
<body>
 <center>
            ...
            <div class="wrapper">
              <h1>Remo en Polea Baja</h1> <div class="div-img hidden" >    <img class="img" src="remopolea.jpg" title="Foto2" alt="Foto2" height="630" width="300" style="border-radius:20px;"">  </div></div>
              <p>Para comenzar el movimiento debemos situarnos en una máquina de poleas, seleccionar el peso a cargar con el ejercicio y sentarnos frente al aparato al cual previamente le tenemos que fijar un manera de doble agarre a la polea baja. Apoyamos los pies en al plataforma y con las rodillas flexionadas y la espalda bien recta tomamos el maneral con ambas manos para dar inicio al ejercicio.<br />

Los brazos en la posición inicial deben quedar extendidos, sujetados a la polea baja mediante el maneral y el torso debe permanecer erguido. Sin movilizar el torso, jalamos del maneral llevando hacia atrás los codos mientras inspiramos, hasta que el maneral queda justo frente al esternón.<br />
