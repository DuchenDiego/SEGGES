...
<body>
 <center>
            ...
            <div class="wrapper">
              <h1>Curl de Piernas Sentado en Maquina</h1> <div class="div-img hidden" >    <img class="img" src="http://static.flickr.com/35/71520058_f3d6f18bd0_o.jpg" title="Foto2" alt="Foto2" height="630" width="300" style="border-radius:20px;"">  </div></div>
              <p>Para comenzar con el movimiento, debemos alinear el eje de rotación de la máquina con el eje de flexión de la rodilla, para ello, movilizaremos el asiento a nuestra comodidad. Posteriormente seleccionaremos el peso a utilizar, nos sentaremos con la espalda completamente apoyada en el respaldar y pasaremos los tobillos por encima de los cojines. Desde allí se inicia el ejercicio.<br />
