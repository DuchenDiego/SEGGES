...
<body>
 <center>
            ...
            <div class="wrapper">
              <h1>Splits</h1> <div class="div-img hidden" >    <img class="img" src="https://cdn.blog.prozis.com/wp-content/blog/images/lunges-jumpes.jpg" title="Foto2" alt="Foto2" height="630" width="400" style="border-radius:20px;"">  </div></div>
              <p>De pie con un pie adelantado y otro retrasado, salte para cambiar la pierna atrasada, adelante y la adelantada, atrás. Realice 8 saltos con cada pierna.
</p>
        </center>
</body>
</html>