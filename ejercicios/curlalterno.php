...
<body>
 <center>
            ...
            <div class="wrapper">
              <h1>Curl Alterno</h1> <div class="div-img hidden" >    <img class="img" src="http://static.flickr.com/34/71520574_f6397b5e5a_o.jpg" title="Foto2" alt="Foto2" height="630" width="300" style="border-radius:20px;"">  </div></div>
              <p>Sentado, una mancuerna en cada mano:<br /> 
-inspirar y flexionar los codos efectuando una rotación externa de la muñeca antes de que los antebrazos alcancen la horizontal; <br />
