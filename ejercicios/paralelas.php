...
<body>
 <center>
            ...
            <div class="wrapper">
              <h1>Paralelas</h1> <div class="div-img hidden" >    <img class="img" src="paralelas.jpg" title="Foto2" alt="Foto2" height="550" width="300" style="border-radius:20px;"">  </div></div>
              <p>Apoyado sobre las barras paralelas, brazos estirados, piernas colgando, inspirar y flexionar completamente los antebrazos sobre los brazos hasta llevar el pecho a nivel de las barras. Efectuar el fondo y espirar al final del esfuerzo. Durante la ejecución, cuanto más inclinado esté el tronco mayor será la participación de los pectorales (parte inferior del esternón). Por el contrario, cuanto más recto esté el tronco, mayor será la solicitación de los tríceps.</p>
        </center>
</body>
</html>