...
<body>
 <center>
            ...
            <div class="wrapper">
              <h1>Dominadas en Barra Fija</h1> <div class="div-img hidden" >    <img class="img" src="barrafija.jpg" title="Foto2" alt="Foto2" height="630" width="300" style="border-radius:20px;"">  </div></div>
              <p>Para comenzar a realizar dominadas, como hemos dicho anteriormente, tenemos que tener cierto tiempo de entrenamiento previo de manera de tener fuerza suficiente en los músculos que serán solicitados. Igualmente, describiremos el ejercicio que todo principiante debe conocer.<br />
