...
<body>
 <center>
            ...
            <div class="wrapper">
              <h1>Press De Banco Plano</h1> <div class="div-img hidden" >    <img class="img" src="http://static.flickr.com/20/71520278_d10aa1843b_o.jpg" title="Foto2" alt="Foto2" height="500" width="300" style="border-radius:20px;"">  </div></div>
              <p>Acostado sobre un banco plano, glúteos en contacto con el banco, pies en el suelo:
<br />
...
Este ejercicio solicita el pectoral mayor en todo su conjunto, el pectoral menor, los tríceps, el deltoides anterior, los serratos y el coracobraquial.</p>
        </center>
</body>
</html>