...
<script>
	$(document).ready(function(e) {
		$('#e1').on('click', function(){
			$('#content').attr('src', 'ejercicios/skipping.php');
		});
		$('#e2').on('click', function(){
			$('#content').attr('src', 'ejercicios/burpee.php');
		});	
		$('#e3').on('click', function(){
			$('#content').attr('src', 'ejercicios/sentadillasalto.php');
		});	
		$('#e4').on('click', function(){
			$('#content').attr('src', 'ejercicios/splits.php');
		});	
	});
</script>
</head>
...
<div class="seccionmenu">
        <ul id="menu">
  	<li><span><a id="e1">Skipping</a></span></li>
		<li><span><a id="e2">Burpee</a></span> </li>
		<li><span><a id="e3">Sentadilla con Salto</a></span></li>
        <li><span><a id="e4">Splits</a></span></li>
	</ul>
    </div>	
    <div class="central">
